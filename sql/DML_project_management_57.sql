...
alter table projects add  column PROJECT_START_DATEd date;
alter table projects add  column PROJECT_END_DATEd date;
update projects set PROJECT_START_DATEd=STR_TO_DATE(PROJECT_START_DATE,'%d.%m.%Y');
update projects set PROJECT_END_DATEd=STR_TO_DATE(PROJECT_END_DATE,'%d.%m.%Y');
alter table projects drop column PROJECT_START_DATE;
alter table projects drop column PROJECT_END_DATE;
alter table projects change  column PROJECT_START_DATEd PROJECT_START_DATE date;
alter table projects change column PROJECT_END_DATEd  PROJECT_END_DATE date;
...
alter table tasks change column TASK_START_DATEd  TASK_START_DATE date;
alter table tasks change column TASK_END_DATEd TASK_END_DATE date;
